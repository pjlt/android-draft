...
import cn.lanthing.stream.Stream
...
-----END CERTIFICATE-----""";
    ...
    private val kDeviceID: Long = 1234567; // TODO: get from local store
    private val socketClient: SocketClient = SocketClient(kHost, kPort, kCertificate, kDeviceID,
        onConnected = {
            setContent {
                MainPage()
            }
